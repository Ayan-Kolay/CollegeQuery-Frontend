      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        >
          ...
          <NavLink
            to="/signup"
            role="menuitem"
            className="focus:outline-none focus-visible:ring-4 ring-neutral-800 rounded-md ring-offset-4 ring-offset-amber-400  hover:shadow-none transition-shadow py-2 px-6 bg-teal-900 text-white "
          >
            Sign Up
          </NavLink>
        </div>
