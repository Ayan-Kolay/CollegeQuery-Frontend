        ...
        <div className="flex justify-center absolute align-middle top-1/4 min-[320px]:left-12 sm:left-20 flex-col lg:flex-row w-9/12 lg:w-10/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 py-8 lg:py-16 px-12">
            ...
            <form action="#">
              ...
              <div className="mt-5">
                <button className="w-full bg-teal-700 py-3 text-center text-white hover:bg-teal-600 hover:shadow-lg focus:bg-teal-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-teal-700 active:shadow-lg transition duration-150 ease-in-out">Log in</button>
              </div>
            </form>
          </div>
        </div>
